...
This project is made by group 5 and the authors of this project are [Djura Beenen](https://github.com/djurabeenen), [Daan Boitelle](https://github.com/daanfhb), [Marit van Wolffelaar](https://github.com/maritvw), [Lisa Franse](https://github.com/LisaFranse) and [Jord Stubbé](https://github.com/jordstub).
...
The following filters were applied to the dataset:
...
- Code for cleaning the data: [data_cleanser.ipynb](https://github.com/maritvw/projectgroup5/blob/main/data_cleanser.ipynb)
- Code for the subquestions: [subquestions folder](https://github.com/maritvw/projectgroup5/tree/main/subquestions)
- The figures used: [figures folder](https://github.com/maritvw/projectgroup5/tree/main/figures)
